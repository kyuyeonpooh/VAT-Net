...
class TextNet(nn.Module):
    def __init__(self):
        ...
        self.conv1_1 = nn.Conv1d(300, 64, kernel_size=3, padding=1, bias=False)
        self.bn1_1 = nn.BatchNorm1d(64)
        self.conv1_2 = nn.Conv1d(64, 64, kernel_size=3, padding=1, bias=False)
        self.bn1_2 = nn.BatchNorm1d(64)

        self.conv2_1 = nn.Conv1d(64, 128, kernel_size=3, padding=1, bias=False)
        self.bn2_1 = nn.BatchNorm1d(128)
        self.conv2_2 = nn.Conv1d(128, 128, kernel_size=3, padding=1, bias=False)
        self.bn2_2 = nn.BatchNorm1d(128)

        self.conv3_1 = nn.Conv1d(128, 256, kernel_size=3, padding=1, bias=False)
        self.bn3_1 = nn.BatchNorm1d(256)
        self.conv3_2 = nn.Conv1d(256, 256, kernel_size=3, padding=1, bias=False)
